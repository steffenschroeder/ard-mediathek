...
class ArdMediathekDownloader:
    ...
    def download(self):
        ...
        """
        self._default_filename_if_empty()

        json = self._fetch_media_information()

        self._generate_subtitle_url(json)

        video = self._generate_video_url(json)
    ...
    def _download_from_url(self, video_url):
